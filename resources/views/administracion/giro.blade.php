...
<x-adminlte-card title="REGISTRO GIRO" class="m-2" theme="dark" icon="fas fa-id-card">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <x-adminlte-input type="text" required name="giro" id="giro" placeholder="Ingrese giro" label-class="text-lightblue">
